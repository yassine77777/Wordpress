...
<?php if ( bbp_current_user_can_access_anonymous_user_form() ) : ?>
	...
	<fieldset class="bbp-form">
		<legend><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? esc_attr_e( 'Author Information', 'bbpress' ) : esc_attr_e( 'Your information:', 'bbpress' ); ?></legend>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

		<p>
			<label for="bbp_anonymous_author"><?php esc_attr_e( 'Name (required):', 'bbpress' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php esc_attr_e( 'Mail (will not be published) (required):', 'bbpress' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php esc_attr_e( 'Website:', 'bbpress' ); ?></label><br />
