...
<ul id="bbp-search-results" class="forums bbp-search-results">
	...
	<li class="bbp-header">
		...
		<div class="bbp-search-author"><?php  esc_attr_e( 'Author',  'bbpress' ); ?></div><!-- .bbp-reply-author -->

		<div class="bbp-search-content">

			<?php esc_attr_e( 'Search Results', 'bbpress' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-search-author"><?php  esc_attr_e( 'Author',  'bbpress' ); ?></div>
