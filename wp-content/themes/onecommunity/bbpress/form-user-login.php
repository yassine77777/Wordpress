...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php esc_attr_e( 'Log In', 'bbpress' ); ?></legend>
		...
		<div class="bbp-password">
			<label for="user_pass"><?php esc_attr_e( 'Password', 'bbpress' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php esc_attr_e( 'Keep me signed in', 'bbpress' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit"><?php esc_attr_e( 'Log In', 'bbpress' ); ?></button>
