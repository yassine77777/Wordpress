...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-author"><?php  esc_attr_e( 'Creator',  'bbpress' ); ?></div><!-- .bbp-topic-author -->

		<div class="bbp-topic-content">

			<?php esc_attr_e( 'Topic', 'bbpress' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-topic-author"><?php  esc_attr_e( 'Creator',  'bbpress' ); ?></div>
