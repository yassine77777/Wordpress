...
<div class="bbp-forum-header">
	...
	<div class="bbp-meta">
		...
		<span class="bbp-forum-post-date"><?php printf( esc_attr__( 'Last updated %s', 'bbpress' ), bbp_get_forum_last_active_time() ); ?></span>
	...
	<div class="bbp-forum-title">
		...
		<h3><?php esc_attr_e( 'Forum: ', 'bbpress' ); ?><a href="<?php bbp_forum_permalink(); ?>"><?php bbp_forum_title(); ?></a></h3>
