...
<ul class="blog-1 <?php if( is_active_sidebar('sidebar-blog') ) { ?>blog-1-sidebar col-2<?php } else { ?>blog-1-full-width col-3<?php } ?> list-unstyled">
...
$wp_query->query('posts_per_page=9'.'&paged=1');
}
...
<span id="load-more-posts-1" class="load-more show" data-posts-type="1" data-tab-page="1" data-nonce="<?php echo esc_attr( $nonce ); ?>"><?php esc_attr_e('Load More', 'onecommunity'); ?></span>
</div>
